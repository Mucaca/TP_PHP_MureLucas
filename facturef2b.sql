...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 17 Mars 2017 à 19:11
...
(7, 'Ludus', 'Ludus', 'Rue de titi', '67000', 'Strasbourg', 'France'),
(8, 'Mure', 'Lucas', '6 Rue des Hirondelles', '68280', 'Sundhoffen', 'Portugal'),
(20, 'Nom1', 'Prenom1', 'Adresse1', '', '', ''),
(22, 'Fernandes', 'Mégane', '6A Rue du Hohlenstein', '68290', 'Lauw', 'France'),
(24, 'Muré', 'Lucas', '22 rue Thiergarten, 1er étage', '67000', 'Strasbourg', 'France'),
(25, 'Dupont', 'Georges', '19 rue des couilles', '52000', 'Pucave', 'Moldavie'),
(27, 'Bonjour', 'Table', 'Client', 'Ca', 'Va', 'Toi ?'),
(33, 'Foubert', 'Guillaume', '2 rue de la Zorn', '67300', 'Schiltigheim', 'France'),
(34, 'Sutterlin', 'Sébastien', '9 Rue de la Zieguelau', '67100', 'Strasbourg', 'France');
...
(3, 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'admin@gmail.com', '2017-03-16'),
(4, 'Lucas', 'da402960ce1e814bbdaf69651422a5128248ea12', 'lucas.mure@gmail.com', '2017-03-16'),
(6, 'Compte1', '1b13450163299559ab27f3c72530262f7fefef5a', 'Compte1', '2017-03-17');
...
--
ALTER TABLE `client`
  MODIFY `NumClient` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
